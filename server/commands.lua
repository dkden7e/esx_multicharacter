ESX.RegisterCommand('setslots', 'staff4', function(xPlayer, args, showError)
...
ESX.RegisterCommand('remslots', 'staff4', function(xPlayer, args, showError)
	local slots = MySQL.scalar('SELECT `slots` FROM `multicharacter_slots` WHERE identifier = ?', {
		args.identifier
	})
...
ESX.RegisterCommand('enablechar', 'staff4', function(xPlayer, args, showError)
...
ESX.RegisterCommand('disablechar', 'staff4', function(xPlayer, args, showError)
